...
do i=1,params%n
if (sngl(matrices%isys(i)).eq.1) systems(1)=1
if (sngl(matrices%isys(i)).eq.2) systems(2)=1
if (sngl(matrices%isys(i)).eq.3) systems(3)=1
if (sngl(matrices%isys(i)).eq.4) systems(4)=1
if (sngl(matrices%isys(i)).eq.5) systems(5)=1
if (sngl(matrices%isys(i)).eq.6) systems(6)=1
if (sngl(matrices%isys(i)).eq.7) systems(7)=1
enddo
...
! lat/lon varies spacially
 ...
 matrices%zc(i)=(1.-t)*(1.-u)*s(i1+1,j1+1,sngl((matrices%isys(i)))) + & 
        t*(1.-u)*s(i1+1,j1,sngl(matrices%isys(i)))+t*u*s(i1,j1,sngl((matrices%isys(i))))+&
        (1.-t)*u*s(i1,j1+1,sngl(matrices%isys(i)))
